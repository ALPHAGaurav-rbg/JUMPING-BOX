...
function draw() {
    ...
    if smallbox.isTouching(box3){
      smallbox.shapeColor = rgb(255,255,0);
    }

    if smallbox.isTouching(box4){
      smallbox.shapeColor = rgb(0,0,255);
    }

    smallbox.bounceOff(box1);
    smallbox.bounceOff(box2);
    smallbox.bounceOff(box3);
    smallbox.bounceOff(box4);
    smallbox.bounceOff(EdgeSprites);
